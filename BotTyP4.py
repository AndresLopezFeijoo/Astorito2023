...
async def seq2(update, context):
    ...
    await update.callback_query.edit_message_text(text=msg[c[1][0]], reply_markup=reply_markup,
                                                  parse_mode=telegram.constants.ParseMode.HTML)
...
async def solf_lst(update, context):
    ...
    await \
        update.callback_query.edit_message_text(text=
                                                "\U0001f916 <strong>Tengo estas lecciones para ofrecerte:...</strong>",
                                                reply_markup=reply_markup, parse_mode=telegram.constants.ParseMode.HTML)
...
async def rep(update, context):
    ...
    await \
        update.callback_query.edit_message_text(text=
                                                "\U0001f916 <strong>Escribime un mensaje con tu reporte.</strong>\n"
